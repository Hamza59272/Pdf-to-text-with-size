...
base_prices = {
            "10-25cm": 50, "25-30cm": 60, 
            "30-35cm": 70, "35-40cm": 80,
            "41-45cm": 85, "46-50cm": 90, 
            "51-55cm": 95, "56-60cm": 100,
            "61-65cm": 105, "66-70cm": 110, 
            "71-75cm": 120, "76-80cm": 130,
            "81-85cm": 140, "86-90cm": 160
        }
...
def Aluminium_Doosletter_Price_calculator(letters, data):
    ...
    try:
        ...
        for letter in letters:
            ...
            width_adjustment = ((width_of_letter - 6) * width_adjustment_per_cm)
